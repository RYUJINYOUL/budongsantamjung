    ...
    return (
      <div className="h-full flex items-center justify-center bg-slate-950 rounded-lg">
        <div className="text-center p-6 max-w-xs">
          <div className="text-rose-500 mb-2 text-2xl">⚠️</div>
          <div className="text-sm font-bold text-white mb-1">지도 로드 실패</div>
          <div className="text-xs text-white/45 mb-4">{loadError}</div>
          <button
            type="button"
