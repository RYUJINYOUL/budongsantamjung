...
export default function KakaoMap({ properties, selectedProperty, onPropertySelect, onBoundsChanged, onMapIdle, onMapDrag, initialCenter, isAnalyzeMode, primaryPolygon, additionalPolygons, onMapClick }: KakaoMapProps) {
  ...
  }, [map, properties, isAnalyzeMode, selectedProperty?.id, zoomLevel]);
