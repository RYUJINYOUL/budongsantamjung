    ...
    return (
        ...
        >
            <div className="flex flex-col gap-4">
                ...
                {/* AI 3사 문의 안내 — 자동 추정이므로 추가 검증 권장 */}
                <div className="p-4 rounded-2xl flex items-start gap-3 bg-white/[0.03] border border-white/[0.08]">
                    <Info className="w-4 h-4 text-white/35 shrink-0 mt-0.5" />
                    <p className="text-white/45 text-[11px] leading-relaxed">
                        위 추정가는 건축물대장 + 공시지가 기반 참고치입니다.{' '}
                        <span className="text-white/65 font-bold">
                            보증금과 총 월세 정보를 복사해 ChatGPT, Claude, Gemini 등 AI에게 정확한 수익환원 계산을 요청해 보세요.
                        </span>
                    </p>
                </div>
            </div>
