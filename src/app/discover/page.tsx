...
// 시군구 코드 → 한국어 이름 매핑 (주요 지역)
const SIGUNGU_NAME: Record<string, string> = {
  '11010':'서울 종로구','11020':'서울 중구','11030':'서울 용산구','11040':'서울 성동구','11050':'서울 광진구',
  '11060':'서울 동대문구','11070':'서울 중랑구','11080':'서울 성북구','11090':'서울 강북구','11100':'서울 도봉구',
  '11110':'서울 노원구','11120':'서울 은평구','11130':'서울 서대문구','11140':'서울 마포구','11150':'서울 양천구',
  '11160':'서울 강서구','11170':'서울 구로구','11180':'서울 금천구','11190':'서울 영등포구','11200':'서울 동작구',
  '11210':'서울 관악구','11220':'서울 서초구','11230':'서울 강남구','11240':'서울 송파구','11250':'서울 강동구',
  '26110':'부산 중구','26140':'부산 서구','26170':'부산 동구','26200':'부산 영도구','26230':'부산 부산진구',
  '26260':'부산 동래구','26290':'부산 남구','26320':'부산 북구','26350':'부산 해운대구','26380':'부산 사하구',
  '26410':'부산 금정구','26440':'부산 강서구','26470':'부산 연제구','26500':'부산 수영구','26530':'부산 사상구',
  '27110':'대구 중구','27140':'대구 동구','27170':'대구 서구','27200':'대구 남구','27230':'대구 북구',
  '27260':'대구 수성구','27290':'대구 달서구','27710':'대구 달성군',
  '28110':'인천 중구','28140':'인천 동구','28177':'인천 미추홀구','28185':'인천 연수구','28200':'인천 남동구',
  '28237':'인천 부평구','28245':'인천 계양구','28260':'인천 서구','28710':'인천 강화군','28720':'인천 옹진군',
  '29110':'광주 동구','29140':'광주 서구','29155':'광주 남구','29170':'광주 북구','29200':'광주 광산구',
  ...
  '36110':'세종특별자치시',
  '41110':'경기 수원시','41113':'경기 수원 장안','41115':'경기 수원 권선','41117':'경기 수원 팔달','41119':'경기 수원 영통',
  '41130':'경기 성남시','41131':'경기 성남 수정','41133':'경기 성남 중원','41135':'경기 성남 분당',
  '41150':'경기 의정부시','41170':'경기 안양시','41171':'경기 안양 만안','41173':'경기 안양 동안',
  '41190':'경기 부천시','41210':'경기 광명시','41220':'경기 평택시','41250':'경기 동두천시',
  '41270':'경기 안산시','41271':'경기 안산 상록','41273':'경기 안산 단원',
  '41280':'경기 고양시','41281':'경기 고양 덕양','41285':'경기 고양 일산동','41287':'경기 고양 일산서',
  '41290':'경기 과천시','41310':'경기 구리시','41360':'경기 남양주시','41370':'경기 오산시',
  '41390':'경기 시흥시','41410':'경기 군포시','41430':'경기 의왕시','41450':'경기 하남시',
  '41460':'경기 용인시','41461':'경기 용인 처인','41463':'경기 용인 기흥','41465':'경기 용인 수지',
  '41480':'경기 파주시','41500':'경기 이천시','41550':'경기 안성시','41570':'경기 김포시',
  '41590':'경기 화성시','41610':'경기 광주시','41630':'경기 양주시','41650':'경기 포천시',
  '41670':'경기 여주시','41800':'경기 연천군','41820':'경기 가평군','41830':'경기 양평군',
};

function getSigunguName(cd: string): string {
  return SIGUNGU_NAME[cd] || cd;
}
            ...
            <div className="shrink-0 px-4 lg:px-5 py-3.5 border-t border-slate-100 bg-white">
              {!user ? (
                ...
                <button
                  ...
                  className="w-full py-3 bg-slate-800 hover:bg-slate-900 text-white font-bold rounded-xl text-xs transition-all shadow-sm active:scale-[0.98] animate-pulse"
                >
                  매물 분석은 앱 - PC에서만 지원 →
                </button>
              ) : (
        ...
        <div className={`w-full flex-1 flex flex-col h-screen overflow-hidden bg-slate-50/50 min-w-0 ${!showMobileList ? 'hidden lg:flex' : 'flex'}`}>
          ...
          <div className="px-6 py-4 bg-white border-b border-slate-200/40 space-y-3 shrink-0">
            ...
            <div className="flex items-center justify-between">
              ...
              <span className="hidden lg:inline-block text-[10px] text-slate-400 font-extrabold shrink-0 ml-4">{filtered.length}건</span>
            </div>
          </div>
