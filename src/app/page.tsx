            ...
            <div className={`flex-1 min-h-0 overflow-y-auto px-4 lg:px-6 py-4 pb-24 ${showMobileMap ? 'hidden lg:block' : 'block'}`}>
              <div className="flex flex-col gap-3 mb-4">
                ...
                <div className="flex items-center justify-between gap-2">
                  ...
                  <span className="text-[10px] text-slate-400 font-extrabold shrink-0 tabular-nums">
          ...
          <div className="flex flex-col gap-3 text-white">
            ...
            <div className="flex flex-col gap-2">
              <div className="flex items-center justify-between text-[11px] bg-white/5 px-3 py-2 rounded-xl border border-white/5">
                <span className="text-slate-400 font-bold">PC 버전</span>
