...
const getRiskColor = (score: string | undefined | null) => {
    const n = parseInt(score || '0');
    if (n > 70) return 'bg-rose-50 text-rose-600 border-rose-100';
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="grid grid-cols-3 gap-2 text-center">
                                <div className="bg-slate-50 border border-slate-200/60 rounded-xl p-3">
                                    <p className="text-xs font-black text-slate-800">{favorites.length}</p>
                                    <p className="text-[9px] text-slate-400 font-bold mt-0.5">찜 목록</p>
                                </div>
                                <div className="bg-slate-50 border border-slate-200/60 rounded-xl p-3">
                                    <p className="text-xs font-black text-slate-800">{myAnalyses.length}</p>
